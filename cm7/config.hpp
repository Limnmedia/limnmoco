...
#define LIMNMOCO_FW_REV           4
#define LIMNMOCO_MOTOR_COUNT      8
#define LIMNMOCO_DMX_COUNT        0
#define LIMNMOCO_GIO_OUT          0
#define LIMNMOCO_GIO_IN           0
#define LIMNMOCO_HW_LIMIT         0
#define LIMNMOCO_FRAME_COUNT      0
// #NOTE: full capabilities of DMC-lite. these are mostly TODO
...
// #NOTE: current capabilites
#define LIMNMOCO_CAPABILITIES 0
...
// #NOTE: the maximum number of steps per second that the m4 co-processor is capable of generating
#define LIMNMOCO_MOTOR_MAX_VELOCITY 200'000

// #NOTE: the rate at which steps are generated by the m4 co-processor
#define LIMNMOCO_M4_STEP_HZ 200'000
